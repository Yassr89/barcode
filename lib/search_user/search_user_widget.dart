  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<AppsRecord>>(
      stream: queryAppsRecord(
        queryBuilder: (appsRecord) => appsRecord.orderBy('name'),
      ),
      builder: (context, snapshot) {
        ...
        List<AppsRecord> searchUserAppsRecordList = snapshot.data!;
                  ...
                  children: [
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Autocomplete<String>(
                                  ...
                                  optionsBuilder: (textEditingValue) {
                                    ...
                                    return textFieldAppsRecordList
                                        .map((e) => e.name)
                                        .toList()
                                        .where((option) {
                    ...
                    if (!FFAppState().searchActive)
                      Align(
                        ...
                        child: Builder(
                          builder: (context) {
                            final nosearch = searchUserAppsRecordList.toList();
