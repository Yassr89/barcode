...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? BarcodeWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => InputInformationWidget(
            saveInformation:
                params.getParam('saveInformation', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'searchUser',
        ...
        FFRoute(
          ...
          builder: (context, params) => InformationCopyWidget(),
        )
